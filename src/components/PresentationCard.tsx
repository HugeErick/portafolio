...
import { Linkedin, Github, Instagram, Crown, FileIcon as FileUser } from 'lucide-react';
import BackgroundParticles from "@/components/decorative/BackgroundParticles";
