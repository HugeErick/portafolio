      ...
      <div className="p-4 md:p-8 flex flex-col md:flex-row items-center gap-6">
        <div className="flex-1 space-y-4">
          ...
          <section className="text-lg text-muted-foreground mb-4">
            <footer>
              I'm a software developer with expertise in full-stack development
          ...
          <div className="flex flex-row items-center justify-between mx-2 px-2 my-2">
            <Link href="https://www.linkedin.com/in/erick-gonzalez-810883335/" target="_blank" rel="noopener noreferrer">
              <Linkedin className="w-6 h-6 text-muted-foreground hover:text-foreground transition-colors" />
            </Link>
            <Separator className="h-6" orientation="vertical" />
            <Link href="https://github.com/HugeErick/" target="_blank" rel="noopener noreferrer">
            ...
            <Separator className="h-6" orientation="vertical" />
            <Link href="https://www.instagram.com/erickgonzalez634/" target="_blank" rel="noopener noreferrer">
              <Instagram className="w-6 h-6 text-muted-foreground hover:text-foreground transition-colors" />
            </Link>
            <Separator className="h-6" orientation="vertical" />
            <Link href="https://www.chess.com/member/ilovefirouzja" target="_blank" rel="noopener noreferrer">
